...
<p class="has-text-align-center has-heading-color has-text-color has-link-color"><?php esc_html_e( 'Sorry Nothing Found. Try searching..!!', 'fse-travel-blog' ); ?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
...
<!-- wp:column {"width":"30%"} -->
<div class="wp-block-column" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"fse-travel-blog","tagName":"div"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->